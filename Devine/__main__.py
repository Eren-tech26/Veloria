...
async def init():
    ...
    LOGGER("Devine").info("Powered by @Aethonix_network")

    try:
        await userbot.one.send_message("@igrischatsupport", "<b>Assistant and Bot started.</b>")
        await userbot.two.send_message("@igrischatsupport", "<b>Assistant 2 started successfully.</b>")
        await userbot.three.send_message("@igrischatsupport", "<b>Assistant 3 started successfully.</b>")
        await userbot.four.send_message("@igrischatsupport", "<b>Assistant 4 started successfully.</b>")
        await userbot.five.send_message("@igrischatsupport", "<b>Assistant 5 started successfully.</b>")
    except Exception as e:
...
async def git_pull_command(client, message):
    ...
    try:
        result = subprocess.run(
            ["git", "pull", "https://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@github.com/paradox-zenu/test", "master"],
